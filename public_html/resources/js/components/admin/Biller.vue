  ...
  <div>
                            ...
                            <thead class="text-body">
                              <tr role="row">
                                ...
                                <th
                                  ...
                                  @click="sorting('country')"
                                  :class="
                                    (this.$data.sortType == 'asc' ||
                                      this.$data.sortType == 'ASC') &&
                                    this.$data.sortBy == 'country'
                                      ? 'sorting_asc'
                                      : (this.$data.sortType == 'desc' ||
                                          this.$data.sortType == 'DESC') &&
                                        this.$data.sortBy == 'country'
                              ...
                              >
                                ...
                                <td>
                                  ...
                                  <a
                                    class=""
                                    href="#"
                                    @click="deletebiller(biller.biller_id)"
                          ...
                          <ul class="pagination pagination-sm m-0 float-right">
                            ...
                            >
                              <a
                                class="page-link"
                                href="#"
                                @click="fetchBillers(pagination.prev_page_url)"
                                >Previous</a
                              >
                            </li>
                            ...
                            >
                              <a
                                class="page-link"
                                href="#"
                                @click="fetchBillers(pagination.next_page_url)"
                                >Next</a
                              >
                            </li>
                          </ul>
    ...
    >
      ...
      <form id="myform">
        <div class="row">
          <div class="col-12">
            ...
            <div class="form-group">
              ...
              <small
                class="form-text text-danger"
                v-if="errors.has('vat_number')"
                v-text="errors.get('vat_number')"
              ></small>
            </div>
            ...
            <div class="form-group">
              ...
              <small
                ...
                v-text="errors.get('company_name')"
              ></small>
            </div>
            ...
            <div class="form-group">
              ...
              <select
                ...
                v-model="biller.country_id"
                @change="fetchStatesByCountryID(biller.country_id)"
              >
                <option
        ...
        <button type="button" @click="addbiller()" class="btn btn-primary">
          Submit
        </button>
      </form>
    </div>
...
export default {
  ...
  methods: {
    ...
    fetchStatesByCountryID(country_id) {
      ...
      axios
        .get("/api/admin/country/" + country_id + "?getStates=1", config)
        .then((res) => {
          if (res.data.status == "Success") {
    ...
    deletebiller(id) {
      if (confirm("Are You Sure?")) {
        this.$parent.loading = true;
        axios
          .delete(`/api/admin/biller/${id}`, this.token)
          .then((res) => {
            if (res.data.status == "Success") {
