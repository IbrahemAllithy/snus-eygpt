        ...
        >
          ...
          <div id="accordion">
            <ul class="nav flex-column">
                    ...
                    <ul class="nav flex-column">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <router-link
                              to="/admin/trash-products"
                              class="nav-link mini-sub-nav-link"
                            >
                              <span class="nav-text">Trashed Products</span>
                            </router-link>
                          </li>
                        </ul>
                      </li>
              ...
              <li
                class="nav-item"
                v-if="$parent.permissions.includes('NewsletterContact-list')"
              >
                  ...
                  <div id="accordion3">
                    <ul class="nav flex-column">
                      ...
                      <!-- <li
                        class="nav-item"
                        v-if="
                          $parent.permissions.includes('update-setting-list')
                        "
                      >
                        <router-link
                          class="nav-link sub-nav-link"
                          data-toggle="collapse"
                          to="/admin/updater-merger"
                          role="button"
                          aria-expanded="false"
                        ...
                        >
                          ...
                          <span class="nav-text">Update Source Code</span>
                        </router-link>
                      </li> -->
                      <li
                        class="nav-item"
                        v-if="
                          setting.is_deliveryboyapp_purchased === '0' &&
                          $parent.permissions.includes('merge-setting-list')
                        "
                      >
                        <router-link
                          class="nav-link sub-nav-link"
                        ...
                        >
                          ...
                          <span class="nav-text">Merge Source Code</span>
                        </router-link>
                      </li>
                    </ul>
                  </div>
