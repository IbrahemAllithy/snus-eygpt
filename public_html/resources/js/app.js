...
let routes = [
    {
        ...
        children: [
            ...
            { path: '/admin/trash-products', component: require('./components/admin/TrashProducts.vue').default, name: 'product-list', meta: { auth: true } },
            ...
            { path: '/admin/site-content', component: require('./components/admin/SiteContent.vue').default, name: 'site-content-manage', meta: { auth: true } },
            ...
            { path: '/admin/updater-merger', component: require('./components/admin/UpdateMerge.vue').default, name: 'update-setting-list', meta: { auth: true } },
            { path: '/admin/merger', component: require('./components/admin/Merge.vue').default, name: 'merge-setting-list', meta: { auth: true } },
