      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-6 img-portion">
              <img class="img-fluid" src="{{ asset('assets/images/snuslogo1.png') }}" alt="Snus Egypt">
          </div>
              ...
              <div class="media-main">
                  <div class="row">
                     <div class="col-12 col-md-6 media-col">
                         <div class="media">
                             <img src="{{ asset('assets/images/snuslogo1.png') }}" alt="Snus Egypt team" class="rounded-circle" style="width:100px;">
                    ...
                    <div class="col-12">
                        <div class="aboutus-carousel-js row">
                            <div class="col-12 col-md-12 col-lg-6">
                                <div class="product">
                                  <article>
                                    <img src="{{ asset('assets/images/snuslogo1.png') }}" class="img-fluid" alt="blogImage">
