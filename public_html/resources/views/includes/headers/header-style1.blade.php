            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 without-auth-login">
                    ...
                    <ul class="link-list pro-header-options">
                        ...
                        <li class="link-item">
                            <a href="{{ url('/login') }}" class="nav-link -before">
                                <i class="fa fa-lock" aria-hidden="true"></i>
                                <span>{{ trans('lables.header-login-register') }}</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-3">
                    <ul class="pro-header-right-options">
                        ...
                        <li class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="headerCartButton"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="headerCartButton">
...
@php
    $header_menu = isset($header_menu->menu) ? json_decode($header_menu->menu, true) : [];
@endphp
<!-- header mobile -->
