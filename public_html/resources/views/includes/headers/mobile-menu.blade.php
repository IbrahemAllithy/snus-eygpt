        ...
        <div class="row align-items-center">
          ...
          <div class="col-8">
            <a href="{{url('/')}}" class="logo" data-toggle="tooltip" data-placement="bottom" title="{{isset(getSetting()['site_name']) ? getSetting()['site_name'] : 'Logo' }}">
              <img class="img-fluid" src="{{isset(getSetting()['site_logo']) ? getSetting()['site_logo'] : asset('01-logo.png') }}" alt="{{isset(getSetting()['site_name']) ? getSetting()['site_name'] : 'Logo' }}" data-fallback="true" onerror="this.onerror=null;this.src='{{ asset('assets/images/snuslogo1.png') }}';">
            </a>
          </div>
          ...
          <div class="col-2 pl-0">
            <ul class="pro-header-right-options">
              ...
              <li class="dropdown">
                <button class="btn dropdown-toggle" type="button" id="headerMobileCartButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="cart-left">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="headerMobileCartButton">
