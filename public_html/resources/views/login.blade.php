...
<script>
    ...
    function sendCode() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ url('') }}" + '/api/client/verifyNumber',
            data:{
                ...
                if(data.status == 'error'){
                    ...
                    success: function(data) {
                        if (data.status == 'success') {
                            ...
                            $('#registerForm').hide();
                            $('#verifyForm').hide();
                            $('#registrationSocials').hide();
                            $('#loginWithPhoneDiv').show();
                        } else {
                            Swal.fire(
                                "Internal Error",
                                "Oops, Not Verified", // had a missing comma
                                "error"
                            )
                        }
    ...
    $("#createAccountWithPhone").click(function (e) { 
        e.preventDefault();
        creatAcountWithPhone();
    });

    function creatAcountWithPhone() {
        firstname = "";
        lastname = "";
