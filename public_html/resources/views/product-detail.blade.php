                    ...
                    if (data.status == 'Success' && data.data) {
                        ...
                        if (data.data.product_video_url != null && data.data.product_video_url != 'null' && data
                            ...
                            image_list_link +=
                                ...
                                (details ? details.title : 'Product') + '">' + data.data.product_video_url + '</a>';
                            image_list +=
                        ...
                        if (galleryDetails.length) {
                            ...
                            for (var g = 0; g < galleryDetails.length; g++) {
                                image_list_link +=
                                    ...
                                    galleryDetails[g].gallary_name +
                                    '" data-fancybox-group="fancybox-button" title="' + (details ? details.title : 'Product')
