                            ...
                            <div class="media-body">
                                <div class="row">
                                    <div class="col-12 col-sm-4 col-md-6">
                                        <p class="mb-0">{{ trans('lables.profile-name') }}:<span
                                            class="profile-username font-weight-bold">info@yourcompanyname.com</span></p>
                                    ...
                                    <div class="col-12 col-sm-4 col-md-6">
                                        ...
                                        <p class="mb-0">{{ trans('lables.profile-email') }}:<span
                                                class="profile-user-email font-weight-bold">info@yourcompanyname.com</span></p>
                                    </div>
                                </div>
                            </div>
