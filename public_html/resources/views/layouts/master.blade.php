...
<body class="snus-modern animation-s1 {{ $data['direction'] === 'rtl' ? 'bodyrtl' : '' }} ">
                    ...
                    if (data.status == 'Success') {
                        ...
                        for (i = 0; i < data.data.length; i++) {
                            ...
                            if (data.data[i].product_type == 'variable') {
                                ...
                                var topCartGallery = data.data[i].product_gallary && Array.isArray(data.data[i].product_gallary.detail)
                                    ? data.data[i].product_gallary.detail : [];
                                var topCartImage = topCartGallery[2] || topCartGallery[1] || topCartGallery[0];
                                if (topCartImage && topCartImage.gallary_path) {
                                    clone.querySelector(".top-cart-product-image").setAttribute('src', topCartImage.gallary_path);
                                }
                    ...
                    if (data.status == 'Success') {
                        ...
                        for (i = 0; i < data.data.length; i++) {
                            ...
                            if (data.data[i].product_type == 'variable') {
                                ...
                                var cartGallery = data.data[i].product_gallary && Array.isArray(data.data[i].product_gallary.detail)
                                    ? data.data[i].product_gallary.detail : [];
                                var cartImage = cartGallery[2] || cartGallery[1] || cartGallery[0];
                                if (cartImage && cartImage.gallary_path) {
                                    clone.querySelector(".cartItem-image").setAttribute('src', cartImage.gallary_path);
                                }
