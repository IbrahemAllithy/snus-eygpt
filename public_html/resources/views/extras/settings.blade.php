<div class="dropdown switecher-new" style="display: none;">
    <button class="btn btn-primary swipe-to-top dropdown-toggle" type="button" id="demoSettingsButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > 
      <i class="fa fa-cogs" aria-hidden="true"></i>
    </button> 
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="demoSettingsButton">
