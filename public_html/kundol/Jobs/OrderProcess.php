...
{
    // remove the Queueable trait from job, you will be able to return the data from your job handle method
    use ApiResponser, Dispatchable, InteractsWithQueue, SerializesModels , Transactions;
    ...
    public function handle()
    {
        try {
            ...
            } elseif ($subtotal > $normalizdSetting['free_shipping_order_price']) {
        ...
        if ($sql) {
            ...
            if ($this->parms['payment_method'] == 'stripe') {
            ...
            } elseif ($this->parms['payment_method'] == 'paypal') {
            ...
            } elseif ($this->parms['payment_method'] == 'braintree') {
            ...
            } elseif ($this->parms['payment_method'] == 'authorize_net') {
            ...
            } elseif ($this->parms['payment_method'] == 'sagepay') {
            ...
            } elseif ($this->parms['payment_method'] == 'razorpay') {
                ...
                try {
                    ...
                    $payment->capture(['amount' => $orderPrice]);
            ...
            } elseif ($this->parms['payment_method'] == 'wallet') {
