...
class SiteContentCatalog
{
    ...
    public static function items(): array
    {
        ...
        return [
            ...
            self::text('home', 'home.slots_title', 'عنوان مساحات المنتجات', 'مساحات للمنتجات الجديدة', 112),
            self::text('home', 'home.slots_subtitle', 'وصف مساحات المنتجات', 'اختَر منتجًا من لوحة التحكم لملء المساحة بصورته وسعره، أو اتركها فارغة لمنتج لاحق', 114),
            self::list('home', 'home.product_slots', 'مساحات المنتجات', [
                ['key' => 'product_slug', 'label' => 'المنتج من الداشبورد', 'type' => 'product'],
                ['key' => 'title', 'label' => 'عنوان بديل (اختياري)', 'type' => 'text'],
                ['key' => 'image', 'label' => 'صورة بديلة (اختياري)', 'type' => 'image'],
            ], [
                ['product_slug' => 'zyn-cool-mint-max', 'title' => '', 'image' => ''],
                ['product_slug' => 'zyn-icy-mint', 'title' => '', 'image' => ''],
                ['product_slug' => 'pablo-exclusive-frosted-ice', 'title' => '', 'image' => ''],
                ['product_slug' => 'velo-cool-peppermint', 'title' => '', 'image' => ''],
                ['product_slug' => '', 'title' => '', 'image' => ''],
                ['product_slug' => '', 'title' => '', 'image' => ''],
                ['product_slug' => '', 'title' => '', 'image' => ''],
                ['product_slug' => '', 'title' => '', 'image' => ''],
            ], 116, 'كل صف مساحة على الصفحة الرئيسية. اترك المنتج فارغًا لتبقى المساحة جاهزة لمنتج جديد.'),
