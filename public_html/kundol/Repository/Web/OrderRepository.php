...
class OrderRepository implements OrderInterface
{
    ...
    public function store(array $parms)
    {
        try {
            ...
            return OrderProcess::dispatchSync($parms);

            return $this->successResponse(OrderProcess::dispatchSync($parms), 'Data Get Successfully!');
        } catch (Exception $e) {
    ...
    {
        // return \Auth::id();
        $data = ['order_id' => 1, 'message' => $parms['comment'], 'customer_id' => \Auth::id()];
        try {
    ...
    public function getfygaroButton()
    {
        ...
        $fygaro_button = (isset(($fygaro_button[2]->value)) ? $fygaro_button[2]->value : '');
