...
class ProductRepository implements ProductInterface
{
    ...
    public function deleted_products()
    {
        ...
        $product = Product::onlyTrashed()->with('detail')->get();

        return $this->successResponse(ProductResource::collection($product), 'Data Get Successfully!');
    ...
    public function restore_deleted($id)
    {
        ...
        try {
            $sql = Product::withTrashed()->find($id)->restore();
        ...
        if ($sql) {
            return $this->successResponse('', 'Product Restore Successfully!');
        } else {
            return $this->errorResponse();
        }
    }
