...
class CountryRepository implements CountryInterface
{
    ...
    public function all()
    {
        try {
            ...
            if (isset($_GET['getcities']) && $_GET['getcities'] == '1') {
    ...
    public function show($country)
    {
        try {
            ...
            if (isset($_GET['getcities']) && $_GET['getcities'] == '1') {
                return $this->successResponse(new CountryResource(Country::with('cities')->countryId($country->id)->firstOrFail()), 'Data Get Successfully!');
            }
